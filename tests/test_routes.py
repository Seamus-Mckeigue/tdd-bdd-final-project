...
class TestProductRoutes(TestCase):
    ...
    def test_get_product_not_found(self):
        """It should return 404 if there is no product for the id"""
    ...
    def test_query_by_name(self):
        ...
        response = self.client.get(
            BASE_URL, query_string=f"name={quote_plus(product_name)}"
        )
    ...
    def test_query_by_category(self):
        ...
        response = self.client.get(
            BASE_URL, query_string=f"category={product_category.name}"
        )
